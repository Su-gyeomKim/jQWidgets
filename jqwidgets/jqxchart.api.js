...
(function(a){
  a.extend(a.jqx._jqxChart.prototype,{
    _moduleApi:true,getItemsCount:function(f,b){
    ...
    getXAxisLabels:function(k){
      ...
      for(var e=0;e<l.data.length;e++){
        if(f){
          d.push({offset:{x:g.x+(b?0:g.width),y:g.y+l.data.data[e]},value:l.data.xvalues[e]})
        }else{
          d.push({
            offset:{x:g.x+l.data.data[e],y:g.y+(b?g.height:0)},value:l.data.xvalues[e]}
                )}
      }
      return d
    },
